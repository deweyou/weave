...
stateDiagram-v2
    ...
    ThemeAwareBrand --> LocalWorkflowNext: next product behavior can start
...
---
*Last updated: 2026-06-07 | Reason: record split renderer app boundary and theme-aware brand assets*
