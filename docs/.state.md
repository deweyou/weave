...
stateDiagram-v2
    ...
    DesktopCI --> LocalWorkflowNext: next product behavior can start
...
- Covered areas: desktop-only structure, package extraction rules, mobile
  ...
  window boundary, theme-aware brand assets, and initial UI design contract
...
---
*Last updated: 2026-06-07 | Reason: record desktop CI coverage and self-contained dependency requirement*
